    ...
    <footer class="footer" style="margin-top: 7rem;">
        <div class="footer-top">
            ...
            <div class="footer-col footer-pengunjung">
                ...
                <ul>
                    <li>Pengunjung Online : 4</li>
                    <li>Pengunjung Hari Ini : 50</li>
                    <li>Pengunjung Kemarin : 200</li>
                    <li>Total Pengunjung : 999</li>
                </ul>
            </div>
            <div class="footer-col footer-halal">
                <img src="assets/img/logo-halal.png" alt="#">
            </div>
            ...
            <div class="footer-col footer-alamat">
                <p>
                    <i class="fas fa-map-marker-alt"></i>
                    Kampung Baru, Gembongan, Krajan, Tanggul Kulon,
                    Kec. Tanggul, Kabupaten Jember, Jawa Timur 68155
                </p>
            </div>
